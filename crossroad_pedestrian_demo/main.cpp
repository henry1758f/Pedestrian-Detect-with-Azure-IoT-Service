...
* \file crossroad_pedestrian_demo/main.cpp
* \example crossroad_pedestrian_demo/main.cpp
*/
...
#ifdef SYNNEX_DEBUG
        slog::info << "[SYNNEX_DEBUG] width : " << width << slog::endl;
        slog::info << "[SYNNEX_DEBUG] height : " << height << slog::endl;
#endif
#ifdef SYNNEX_DEBUG
#endif
        // -----------------------------------------------------------------------------------------------------
